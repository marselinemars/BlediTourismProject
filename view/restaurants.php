...
<html lang="en">
  <head>
    <title>city restaurants-bleditourism</title>
    <meta
      property="og:title"
    ...
    <link href="./view/cityhotels.css" rel="stylesheet" />
        ...
        <?php
                                       ...
                                       if (empty($items)) {
                                        if ($city=="Algeria"){
                                          ...
                                          width: 50%;
                                          text-align: center;
                                        }" class="guideprofie-text07 mycard"> Ooooops . There is no restaurants subscribed yet !  </p> ';
            ...
            <div class="cityguides-blog-post-card">
              ...
              <div class="cityguides-container08">
                <div class="cityguides-container09">
                  ...
                  <span class="cityguides-text04">
                  <?php echo htmlspecialchars($items[$i]['city']);?>
                  </span>

                </div>
                <a href="index.php?action=restaurant_profile&mine=false&name=<?php echo htmlspecialchars($items[$i]['name']);?>" class="cityguides-navlink06">
                  visit profile -&gt;
                </a>
              </div>
            </div>
