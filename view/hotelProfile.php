...
<html lang="en">
    <head>
        <title>hotel profile - bleditourism</title>
      ...
      <div class="guideprofie-container">
        ...
        echo '<a style="margin:auto 10px;" href="index.php?action=logout" class="guideprofie-register button">
         Logout
          ...
          <a href="index.php?action=all-hotels" class="guideprofie-navlink7 button">
            back to all hotels
          </a>
          ...
          <div class="guideprofie-container09 tab-buttons">
            ...
            <div class="guideprofie-container11 tab-button " onclick="openTab(event, 'tab2')">
              <h1 class="guideprofie-text03">rooms</h1>
            </div>
...
?>
        ...
        <div class="circuit-card">
          <h2 class="circuit-title"><?php echo htmlspecialchars($rooms[$i]['title']);?> :</h2>
          <p class="circuit-description"><?php echo htmlspecialchars($rooms[$i]['description']);?> </p>
          <p class="circuit-date"><?php echo htmlspecialchars($rooms[$i]['date']);?></p>
        </div>
        <?php  }  }?>
...
<?php if ($role==="hotel" && $mine=='true'){
echo '<button  style="display:block; width:100%;margin-top:60px;" id="show-form-btn"onclick="show_circuit(event)"><span class="guideprofie-text18">Add room -&gt;</span></button>';
      }?>

<div id="circuit-dialog" style="display:none;">
<button  onclick="close_dialog(event)" class="close-button">&#10006;</button>
<form id="newcircuit_form" action="index.php?action=hotel_add_room"  method="post">

<label for="">type of room  : </label>
<input type="text" name="title" id="title-input-2" placeholder="write the title here ">
<label for="">The date of the reservation : </label>
<input type="date" name="date" id="date-input-2" placeholder="enter the date here ">
<label for="">The description and details of the room reservation : </label>
...
<button style="margin:20px auto 10px ; width:100%;" onclick="close_dialog(event)" class = "button guideprofie-navlink6 " type="submit"  name="submit-btn">Add</button>
          ...
          for ($i=0;$i<count($feedbackshotel);$i++){
            $starhtml= generateStarRating ($feedbackshotel[$i]['rating']);
            ?>
          ...
          <div class="feedback-details">
            <p class="author"><?php echo htmlspecialchars($feedbackshotel[$i]['visitor']);?> </p>
            <p class="comment"><?php echo htmlspecialchars($feedbackshotel[$i]['opinion']);?></p>
          </div>
...
<button  onclick="close_dialog(event)" class="close-button">&#10006;</button>
<form id="newfeedback_form" action="index.php?action=hotel_add_feedback"  method="post">


<label for="">your rating of this : </label>
<input type="number" max="5" min="0" step="0.5" name="rating" id="title-input-3" placeholder="/5">
<label for=""> your opinion about this hotel :  </label>
...
function uploadImage() 
{
  ...
  xhr.open('POST', 'index.php?action=hotel_add_to_gallery', true);
...
function add_circuit() 
{
  ...
  // Define the AJAX request
  xhr.open('POST', 'index.php?action=hotel_add_room', true);
...
function add_feedback() 
{
  ...
  // Define the AJAX request
  xhr.open('POST', 'index.php?action=hotel_add_feedback', true);
