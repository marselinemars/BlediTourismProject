...
.guideprofie-navlink6 {
    ...
    text-decoration: none;
    background-color: rgb(57, 112, 123);
}



            .guideprofie-navlink6:hover {
    color: #39707b;
    border-width: 2px;
    background-color: var(--dl-color-gray-white);
}
    ...
    <link rel="stylesheet" href="view/tourism.css" />
...
.jardin {
  margin-bottom: 1px; /* Adjust the value as per your preference */
...
.images img:hover {
  transform: translate(5px, -5px); /* Adjust the values as per your preference */
}
...
.activity {
  ...
  border-radius: 10px;
    ...
    const movingPhoto = document.querySelector('.moving-photo');

movingPhoto.addEventListener('mousemove', (event) => {
  // Adjust the values based on how much you want the photo to move
  const xMovement = event.clientX / 50; 
  const yMovement = event.clientY / 50;

  movingPhoto.style.transform = `translate(${xMovement}px, ${yMovement}px)`;
});

movingPhoto.addEventListener('mouseout', () => {
  movingPhoto.style.transform = 'translate(0, 0)';
});
          ...
          <div class="cityguides-container03">
            ...
            <div  style="width:100%;" class="homepage-container">
              <div class="homepage-container01">
                    ...
                    <div class="container" >
                  <div class="Alger"><h2 class="welcome" >Welcome To <br><span style="color:#39707b">Algeria</span></h2>
