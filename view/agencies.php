...
<html lang="en">
  <head>
    <title>city agencies-bleditourism</title>
    <meta
      property="og:title"
  ...
  background-image: url("https://content.api.news/v3/images/bin/4491bf978b849ce0b2f54b196c81cbd9");
}
    </style>
            ...
            <div class="cityguides-container04">
              ...
              <div class="cityguides-container06">
                <h1 class="cityguides-text01">
                  meet the touristic agencies of&nbsp;
                </h1>
...
if (empty($items)) {
  if ($city=="Algeria"){
    ...
    width: 50%;
    text-align: center;
  }" class="guideprofie-text07 mycard"> Ooooops . There is no touristic agencies subscribed yet !  </p> ';
           ...
           <div class="cityguides-container07">
            <div class="cityguides-blog-post-card">
              ...
              <div class="cityguides-container08">
                ...
                <a href="index.php?action=agency_profile&mine=false&name=<?php echo htmlspecialchars($items[$i]['name']);?>" class="cityguides-navlink06">
                  visit agency -&gt;
                </a>
              </div>
            </div>
